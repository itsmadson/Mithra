...
/**
 * The dashboard home: what has been surveyed, and a panel to survey something
 * new. Landing straight on a blank map with a rectangle tool told an operator
 * nothing about the work already done.
 */
